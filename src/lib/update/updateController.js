...
const GITHUB_LATEST =
        "https://api.github.com/repos/ItsMagisterio/YandexNextMusic_client/releases/latest";
const RELEASES_PAGE =
        "https://github.com/ItsMagisterio/YandexNextMusic_client/releases/latest";
...
async function runSystemPackageUpdate() {
        ...
        const installedBin = "/usr/bin/yandex-next";
        ...
        return new Promise((resolve, reject) => {
                ...
                function request(currentUrl) {
                        https
                                .get(
                                        currentUrl,
                                        { headers: { "User-Agent": "YandexNext-Updater" } },
                                        (res) => {
                                                if (
                                                        res.statusCode >= 300 &&
                                                        res.statusCode < 400 &&
